...
const Calendar: React.FC = () => {
  ...
  return (
    ...
    <div className="w-full h-5/6 bg-white flex flex-col sm:flex-row p-4 pt-0 px-8 border-t ">
      ...
      {/* Month Column */}
      <div className='sticky flex flex-col text-2xl font-normal border-r'>
  ...
  return (
    <Dialog key={idx}>
      <DialogTrigger>
        <div className={`${event.color} text-white text-xs sm:text-xs md:text-sm lg:text-xl rounded px-2 py-1 my-1  mr-1 text-wrap justify-start`}>
        <span
          className=""

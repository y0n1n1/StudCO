...
const Finances = () => {
  ...
  return (
    ...
    <div className=" m-4 mx-[600px] p-4 bg-yellow-200 rounded-3xl">Notice - Full Report of Student Council finances is not currently available. The latest balance is from 24/09/2024</div>

...
const Home = () => {
  return (
    <div>
      <section
        id="home"
        className="relative bg-cover bg-center bg-no-repeat h-screen px-1 sm:px-12 md:px-28 lg:px-40"
      ...
      >
        ...
        <div className="container  h-full flex flex-col justify-center items-center relative z-10 text-center">
          <h1 className="text-7xl font-bold text-white w-full">Welcome to the Student Council</h1>

...
const eventsThis = [
    ...
    },
    {
      ...
      description: "The Head Students have a meeting with our Principal to discuss the Green Wall, the Student Council website, Spirit Week, and more",
      startDate: new Date(2024, 11, 2),
      endDate: new Date(2024, 11, 2),
      color:"bg-purple-500",
    },
    {
      title: 'Meeting on Uniform Changes with Ms Hartstein and Mr Tomalin',
      description: "Student Council Representatives from all years in Secondary meet with Ms Hartstein and Mr Tomalin, and provide feedback on uniform ideas by the School Administration.",
      startDate: new Date(2024, 11, 6),
      endDate: new Date(2024, 11, 6),
      color:"bg-purple-500",
    },
    ...
    {
      title: 'End of Term 1 Break',
      description: 'Take a break and recharge during the end of term break.',
    ...
    },
    {
      ...
      description: 'Take a break and recharge during this mid-term holiday.',
    ...
    {
      title: 'School Holiday',
      description: "Take a break and recharge during this holiday",
    ...
    },
    {
      ...
      description: "Put your backpack away and go enjoy summer!",
      startDate: new Date(2025, 5, 30),
      endDate: new Date(2025, 5, 30),
      color:"bg-blue-500",
    },
    {
      title: 'Holiday 🇵🇹 Portugal Day',
